import type { EAuthServiceViaEmailAction, TAuthCredentials } from '@/types/auth';
...
export const authService = {
   ...
   * @param {EAuthServiceViaEmailAction} action - The action to perform (sign in or sign up)
