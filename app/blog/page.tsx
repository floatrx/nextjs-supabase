...
export default async function BlogPage(props: PageProps<EmptyObj, PostSearchParams>) {
  ...
  return (
    <Page actions={<PostCreateButton />} className="space-y-6" count={posts.count} title="Blog">
      <PostSearchFilters />
